...
def _cb_feng_delays(sensors, f_host):
    ...
    try:
        ...
        sensors['pol0_crc_err_cnt'].set(value=results['hmc_crc_err_cnt_pol0'],errif='changed')
        sensors['pol1_crc_err_cnt'].set(value=results['hmc_crc_err_cnt_pol1'],errif='changed')
        hmc_post=((results['hmc_init'])&(results['hmc_post']))
        sensors['hmc_post'].set(value=hmc_post,status=Corr2Sensor.NOMINAL if hmc_post else Corr2Sensor.ERROR)

        pol0_errs=results['reord_jitter_err_cnt_pol0']+results['hmc_overflow_err_cnt_pol0']+results['parity_err_cnt_pol0']
        pol1_errs=results['reord_jitter_err_cnt_pol1']+results['hmc_overflow_err_cnt_pol1']+results['parity_err_cnt_pol1']
        sensors['pol0_err_cnt'].set(value=pol0_errs,errif='changed')
        sensors['pol1_err_cnt'].set(value=pol1_errs,errif='changed')

        sensors['reorder_missing_err_cnt_pol0'].set(value=results['reord_missing_err_cnt_pol0'],warnif='changed')
        sensors['reorder_missing_err_cnt_pol1'].set(value=results['reord_missing_err_cnt_pol1'],warnif='changed')
...
def _cb_feng_ct(sensors, f_host):
    ...
    try:
        ...
        common_errs=results['obuff_bank_err_cnt']+results['rd_go_err_cnt']+results['sync_in_err_cnt']+results['fifo_full_err_cnt']
        pol0_errs=results['bank_err_cnt_pol0']+results['hmc_overflow_err_cnt_pol0']+common_errs
        pol1_errs=results['bank_err_cnt_pol1']+results['hmc_overflow_err_cnt_pol1']+common_errs
        ...
        sensors['pol0_post'].set(value=results['hmc_post_pol0'],status=pol0_status)
        sensors['pol1_post'].set(value=results['hmc_post_pol1'],status=pol1_status)
        sensors['pol0_crc_err_cnt'].set(value=results['hmc_crc_err_cnt_pol0'],errif='changed')
        sensors['pol1_crc_err_cnt'].set(value=results['hmc_crc_err_cnt_pol1'],errif='changed')
        sensors['reorder_missing_err_cnt'].set(value=results['reorder_missing_err_cnt'],warnif='changed')
