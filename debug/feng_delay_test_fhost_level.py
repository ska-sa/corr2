...
print('delay after = %d'%vals['act_delay'])
print('delta delay after = %f'%vals['act_delta_delay'])
print('phase offset after = %f'%vals['act_phase_offset'])
print('delta phase offset after = %f'%vals['act_delta_phase_offset'])
