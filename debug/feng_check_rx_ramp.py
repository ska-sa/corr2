...
gbepackets = packetise_snapdata(coredata, eof_key=eof_key)
speadpacket = gbe_to_spead(gbepackets[0][data_key])
speadpacket1 = gbe_to_spead(gbepackets[1][data_key])
...
w80 = unpack64_to_80(speadpacket['data'])
w80.extend(unpack64_to_80(speadpacket1['data']))

for word80 in w80:
    stime = word80 >> 32
    pkt_ctr = (word80 & 0xffffffff) >> 1
    pol = word80 & 0x01
    print stime, pkt_ctr, pol
