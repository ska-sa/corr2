...
try:
    ...
    while main_loop_ctr < CORR_INIT_LOOPS:
        ...
        if corr_init_attempts == CORR_INIT_RETRIES:
            ...
            raise RuntimeError('Failed too many times initialising the correlator')
        ...
        for ant in ant_names:
            ...
            c.fops.eq_set(source_name=ant, new_eq=300000)
            print(c.fops.eq_get(c)
